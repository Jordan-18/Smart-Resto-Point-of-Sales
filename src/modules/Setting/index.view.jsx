...
function Setting({event, children}){
    ...
    async function setBreadcrumb(){
        let toolbarDefault = {title: 'Setting', toolbar : {Setting : '/setting'}}
            ...
            {loading ? (
                ...
                <Content event={toolbar}>
                    ...
                    <div className="tab-content">
                        {/* {routeChild && Object.entries(routeChild).map(([key, value], index) => (
                            <div key={index} className="tab-pane" id={`home-${index}`} role="tabpanel" aria-labelledby="home-tab">
                                <value.component/>
                            </div>
                        ))} */}
