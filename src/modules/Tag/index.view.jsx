...
import { getTag, deleteTag } from './index.service.js'
...
const actionButton = params => {
    ...
    const handleDelete = async (event) => {
        const status = await deleteTag({event,api: params.url,id: data.dish_id,token: params.token});
